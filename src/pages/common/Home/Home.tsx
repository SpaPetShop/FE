      ...
      />
         ...
         <TabContext value={value}>
          <TabList
            ...
            sx={{ borderBottom: theme => `1px solid ${theme.palette.divider}` , ml: 10, mb: 3}}
          >
            <Tab
              value='COMBO'
              label={
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <TabName sx={{fontWeight:700, fontSize:18}}>Gói sản phẩm</TabName>
                </Box>
              }
            />       
            <Tab
              ...
              label={
                <Box sx={{ display: 'flex', alignItems: 'center' }}>
                  <TabName sx={{fontWeight:700, fontSize:18}}>Sản phẩm</TabName>
                </Box>
              }
            />
          </TabList>
